...
<body>
<form name="mainform" id="mainform" method="post" action="Invoice">
  <table width="100%" cellspacing="1" >
    <tr>
      <td colspan="5"><center>
	  <H1 class="labelH1"> Cashbill </H1>
	  </center>	 
	  <input type="hidden" id="mode" value="<%String mode=request.getParameter("mode"); out.write(mode);%>">
	  <input type="hidden" name="action" id="action" value="cashsell">
	  <input type="hidden" name="page" id="page" value="Cashbill">  
	  </td>
    </tr>
    <tr>
...
%>
      ...
      <td colspan="2"><div align="center" >
        <input type="text" class="disableddata dynnumint" name="billno" id="billno" 
    ...
    <tr>
      ...
      <td width="12%"><div align="center">
        <input id="submit" name="submit" type="submit" class="button" value="Sell">
      </div></td>
